...
然而实际执行结果却并非如此， 如下图：
![在声明之前使用函数和变量的执行结果](07-img/fbafaba4ad7092cbee011a8a02e38903.webp)
...
![使用了未定义的变量——执行报错](07-img/a5262e2ca891ea114dfaf1e37f9ca4c2.webp)
...
不过在介绍变量提升之前，我们先通过下面这段代码，来看看什么是 JavaScript 中的**声明和赋值**。
...
如下图所示：
![如何理解`var myname = '极客时间'`](07-img/ec882f2d9deec26ce168b409f274533c.webp)
...
![函数的声明和赋值](07-img/611c09ab995b9b608d9c0db193266777.webp)
...
![模拟变量提升示意图](07-img/cefe564dbff729e735a834fd9e3bd0d5.webp)
...
![JavaScript 的执行流程图](07-img/649c6e3b5509ffd40e13ce9c91b3d91e.webp)
...
![JavaScript 执行流程细化图](07-img/0655d18ec347a95dfbf843969a921a13.webp)
...
* 在编译阶段，变量和函数会被存放到**变量环境**中，变量的默认值会被设置为 undefined；在代码**执行阶段**，JavaScript 引擎会从变量环境中去查找自定义的变量和函数。
