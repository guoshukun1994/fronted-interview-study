...
环境准备好了之后，我们就可以生成站点在加载阶段的性能报告了，这里我们可以拿[B 站](https://www.bilibili.com/index.html?redirectFrom=h5)作为分析的列子。
...
最终打开的页面如下图所示：
![最终打开的页面如下图所示：](02-img/f47e598b2fe371e0af067c74756a8909.webp)
...
![生成的报告图](02-img/c0420197cc60fb91af2f38903afc8022.webp)
...
![性能指标](02-img/d27cde1230afbabf6f914ee987c15026.webp)
...
![页面加载过程](02-img/7041b4d913a12d4d53041e8ed8b30499.webp)
...
我们先来分析下第一项指标 **FP**，如果 FP 时间过久，那么直接说明了一个问题，那就是页面的 HTML 文件可能由于网络原因导致加载时间过久，这块具体的分析过程你可以参考《21｜Chrome 开发者工具：利用网络面板做性能分析》这节内容。
