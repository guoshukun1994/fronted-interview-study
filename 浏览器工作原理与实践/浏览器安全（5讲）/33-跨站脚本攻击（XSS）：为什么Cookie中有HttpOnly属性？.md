...
#### 什么是 XSS 攻击
SS 全称是 Cross Site Scripting，为了与“CSS”区分开来，故简称 XSS，翻译过来就是“跨站脚本”。XSS 攻击是指黑客往 HTML 文件中或者 DOM 中注入恶意脚本，从而在用户浏览页面时利用注入的恶意脚本对用户实施攻击的一种手段。
...
![存储型 XSS 攻击](32-img/2ed3d8b93035df3c2bcfcc223dc47914.webp)
...
![黑客将恶意代码存储到漏洞服务器上](32-img/5479e94a06d9a7cdf3920c60bf834249.webp)
...
![用户打开了含有恶意脚本的页面](32-img/efaf4123438f37da4c7366b87ed1403a.webp)
...
![将 Cookie 等数据上传到黑客服务器](32-img/b19300e39a753774f4a94635b46af7cb.webp)

黑客拿到了用户 Cookie 信息之后，就可以利用 Cookie 信息在其他机器上登录该用户的账号（如下图），并利用用户账号进行一些恶意操作。

![黑客利用 Cookie 信息登录用户账户](32-img/720c6daf21a8adf55329af9eaa5ab052.webp)
...
![正常打开页面](32-img/7ecb717abadfff2637a168d39f0c3cdb.webp)

但当打开http://localhost:3000/?xss=这段 URL 时，其结果如下图所示：
![反射型 XSS 攻击](32-img/4dff7d83fe2eecc6cb52c126b4f650fa.webp)
...
![HttpOnly 演示](32-img/defa78c90a4e8f0debb09564561ab9bb.webp)
