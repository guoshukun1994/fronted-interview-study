...
![从输入 URL 到页面展示完整流程示意图](04-img/92d73c75308e50d5c06ad44612bcb45d.webp "从输入 URL 到页面展示完整流程示意图")
...
![开始加载 URL 浏览器状态](04-img/fad33fc7c5f2bdf4e20cac7691484130.webp "开始加载 URL 浏览器状态")
...
![响应行返回状态码 301](04-img/655cbf32dd4bb6f9decc5c7f9a535a7e.webp "响应行返回状态码 301")
...
我们看到服务器返回如下信息
![响应行返回状态码 200](04-img/0c4987fe5d05646fa8245d8cc50d1a43.webp "响应行返回状态码 200")
...
返回信息如下图：
![含有 HTML 格式的 Content-Type](04-img/8951e161b5f44a73e52c16b631a63e1c.webp "含有 HTML 格式的 Content-Type")
从图中可以看到，响应头中的 Content-type 字段的值是 text/html，这就是告诉浏览器，服务器返回的数据是 **HTML 格式**。

`接下来我们再来利用 curl 来请求极客时间安装包的地址，如下所示：`

请求后返回的响应头信息如下：
![含有 stream 格式的 Content-Type](04-img/595902748d7d4c2f9c1d4783962ae43b.webp "含有 stream 格式的 Content-Type")
...
![多个页面运行在一个渲染进程中](04-img/d8fe2afbd8ea2d4a8d8cc4bb14c50f28.webp "多个页面运行在一个渲染进程中")
...
![非同一站点使用不同的渲染进程](04-img/fba1dd05f0aeba93a5cb25f305971274.webp "非同一站点使用不同的渲染进程")
...
![导航完成状态](04-img/d3c5a6188b09b5b57af439005ae7dfb8.webp "导航完成状态")
...
![渲染结束](04-img/bef45eb5b01c34e328486004feedd658.webp "渲染结束")
