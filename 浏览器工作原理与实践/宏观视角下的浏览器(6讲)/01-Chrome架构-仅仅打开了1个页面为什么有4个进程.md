...
![Chrome 的任务管理器窗口](01-img/ce7f8cfe212bec0f53360422e3b03a9e.webp)
...
![单线程与多线程的进程对比图](01-img/3380f0a16c323deda5d3a300804b95da.webp)
...
![线程之间共享进程中的数据示意图](01-img/d0efacd7f299ed99e776cb97da2a799e.webp)
...
在了解了进程和线程之后，我们再来一起看下单进程浏览器的架构。顾名思义，**单进程浏览器是指浏览器的所有功能模块都是运行在同一个进程里**，这些模块包含了网络、插件、JavaScript 运行环境、渲染引擎和页面等。其实早在 2007 年之前，市面上浏览器都是单进程的。单进程浏览器的架构如下图所示：![单进程浏览器架构示意图](01-img/6ddad2419b049b0eb2a8036f3dfff1ca.webp)
...
![早期 Chrome 进程架构图](01-img/cdc9215e6c6377fc965b7fac8c3ec960.webp)
...
![最新的 Chrome 进程架构图](01-img/b61cab529fa31301bde290813b4587fc.webp)
...
![Chrome“面向服务的架构”进程模型图](01-img/329658fe821252db47b0964037a1de2a.webp)
...
![在资源不足的设备上，将服务合并到浏览器进程中](01-img/a9ba86d7b03263fa3997d3733d958176.webp)
